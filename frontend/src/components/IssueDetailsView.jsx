...
export default function IssueDetailsView({
  ...
  const fetchIssueDetails = async () => {
    try {
      ...
      console.log('Using local client state for issue details.');
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.chat_message) {
          // Replace temp with verified message
          setIssue(prev => ({
            ...prev,
      ...
      console.log('Message sent locally in offline mode.');
    } finally {
  ...
  const handlePostBulletin = async (e) => {
    ...
    try {
      ...
      console.log('Bulletin posted locally.');
    } finally {
  ...
  const handleSaveStatusUpdate = async () => {
    ...
    try {
      ...
      console.log('Status updated in local client session.');
    } finally {
  ...
  if (loading || !issue) {
    return (
      <div className="details-loading-box">
        ...
        <p className="text-slate-500 font-semibold mt-3">Loading complaint details & conversation...</p>
      </div>
    );
  }

  // 5-Stage Visual Progress Tracker Stages
  const standardStages = [
    { key: 'Submitted', label: '1. Submitted', icon: '📝' },
    { key: 'Under Review', label: '2. Verified', icon: '🔍' },
  ...
  return (
    <div className="issue-details-page">
      ...
      <div className="details-hero-card">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-4">
          <div>
            ...
            <div className="details-meta-row">
              ...
              <span>•</span>
              <span>🏢 Assigned: <strong>{issue.department || 'Unassigned'}</strong></span>
            </div>
          </div>
            ...
            <div className={`details-sla-box ${isBreached ? 'breached' : ''}`}>
              ...
              <div>
                ...
                <div className="sla-box-val">
                  {isBreached ? 'Overdue for action' : `${issue.sla_hours || 48}h Target Window`}
                </div>
              </div>
            </div>
          )}
        ...
        <div className="visual-tracker-container">
            ...
            <div className="details-card">
              ...
              {galleryImages.length > 0 ? (
                ...
                <div className="empty-photos-box">
                  ...
                  <p className="text-[11px] text-slate-400 mt-1">Citizens and Admins can upload photos in the Citizen-Admin Chat tab.</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="details-card">
              ...
              <div className="space-y-3 mt-3">
                ...
                <div className="dept-detail-item">
                  ...
                  <span className="val text-indigo-600 font-semibold">{issue.assigned_to || 'Pending Officer Assignment'}</span>
                </div>
                <div className="dept-detail-item">
